...
class Config(object):
    ...
    DEBUG = False
    TESTING = False
    SECRET_KEY = os.getenv('SECRET_KEY', default='321360c95943bb87d5e445ee27bbc6a6')
    ...
    MAIL_USE_TLS = False
    MAIL_USE_SSL = True
    MAIL_USERNAME = os.getenv('MAIL_USERNAME', default='htm.testtest01@gmail.com')
    MAIL_PASSWORD = os.getenv('MAIL_PASSWORD', default='Acb123123')
    MAIL_DEFAULT_SENDER = os.getenv('MAIL_USERNAME', default='htm.testtest01@gmail.com')

    # Alpha Vantage API Key
    ALPHA_VANTAGE_API_KEY = os.getenv('ALPHA_VANTAGE_API_KEY', default='BMV5K4TVV6QV09OZ')
